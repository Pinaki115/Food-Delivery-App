...
<body>
    ...
    <style>
        ...
        .Restrurent_card_menu{display:none;font-size:15px;}
    ...
    <div id="Search_resturent">
        ...
        <div id="Search_resturent_slider">
            <div class="Search_resturent_slider_card" onclick="openRestrurentDetails('Happy-Meal-house')"><img src="https://cdn.pixabay.com/photo/2018/11/15/08/19/surface-3816738_640.jpg" alt="Shop image"><span><h6>Happy Meal house</h6><p>Near gargi hostel</p><h5 class="Search_resturent_slider_card_discount">10% discounts</h5><p>100 options</p><b>₹10 - ₹1000</b><p>Veg and Non - veg both</p><h2 class="Restrurent_card_menu">Happy Meal house 10% discount Noodles</h6></span><p class="Search_resturent_slider_card_rating fa-solid fa-star"> 4</p></div>
            <div class="Search_resturent_slider_card" onclick="openRestrurentDetails('Happy-Meal-house')"><img src="https://cdn.pixabay.com/photo/2018/11/15/08/19/surface-3816738_640.jpg" alt="Shop image"><span><h6>Happy Meal house</h6><p>Near gargi hostel</p><h5 class="Search_resturent_slider_card_discount">20% discounts</h5><p>100 options</p><b>₹10 - ₹1000</b><p>Veg and Non - veg both</p><h2 class="Restrurent_card_menu">Happy Meal house 20% discount Cakes</h6></span><p class="Search_resturent_slider_card_rating fa-solid fa-star"> 4</p></div>
            <div class="Search_resturent_slider_card" onclick="openRestrurentDetails('Happy-Meal-house')"><img src="https://cdn.pixabay.com/photo/2018/11/15/08/19/surface-3816738_640.jpg" alt="Shop image"><span><h6>Happy Meal house</h6><p>Near gargi hostel</p><h5 class="Search_resturent_slider_card_discount">30% discounts</h5><p>100 options</p><b>₹10 - ₹1000</b><p>Veg and Non - veg both</p><h2 class="Restrurent_card_menu">Happy Meal house 30% discount Juice</h6></span><p class="Search_resturent_slider_card_rating fa-solid fa-star"> 4</p></div>
            <div class="Search_resturent_slider_card" onclick="openRestrurentDetails('Happy-Meal-house')"><img src="https://cdn.pixabay.com/photo/2018/11/15/08/19/surface-3816738_640.jpg" alt="Shop image"><span><h6>Happy Meal house</h6><p>Near gargi hostel</p><h5 class="Search_resturent_slider_card_discount">40% discounts</h5><p>100 options</p><b>₹10 - ₹1000</b><p>Veg and Non - veg both</p><h2 class="Restrurent_card_menu">Happy Meal house 10% discount Rice</h6></span><p class="Search_resturent_slider_card_rating fa-solid fa-star"> 4</p></div>
            <div class="Search_resturent_slider_card" onclick="openRestrurentDetails('Happy-Meal-house')"><img src="https://cdn.pixabay.com/photo/2018/11/15/08/19/surface-3816738_640.jpg" alt="Shop image"><span><h6>Happy Meal house</h6><p>Near gargi hostel</p><h5 class="Search_resturent_slider_card_discount">50% discounts</h5><p>100 options</p><b>₹10 - ₹1000</b><p>Veg and Non - veg both</p><h2 class="Restrurent_card_menu">Happy Meal house 60% discount Paratha</h6></span><p class="Search_resturent_slider_card_rating fa-solid fa-star"> 4</p></div>
            <div class="Search_resturent_slider_card" onclick="openRestrurentDetails('Happy-Meal-house')"><img src="https://cdn.pixabay.com/photo/2018/11/15/08/19/surface-3816738_640.jpg" alt="Shop image"><span><h6>Happy Meal house</h6><p>Near gargi hostel</p><h5 class="Search_resturent_slider_card_discount">60% discounts</h5><p>100 options</p><b>₹10 - ₹1000</b><p>Veg and Non - veg both</p><h2 class="Restrurent_card_menu">Happy Meal house 40% discount Fruits</h6></span><p class="Search_resturent_slider_card_rating fa-solid fa-star"> 4</p></div>
            <div class="Search_resturent_slider_card" onclick="openRestrurentDetails('Happy-Meal-house')"><img src="https://cdn.pixabay.com/photo/2018/11/15/08/19/surface-3816738_640.jpg" alt="Shop image"><span><h6>Happy Meal house</h6><p>Near gargi hostel</p><h5 class="Search_resturent_slider_card_discount">10% discounts</h5><p>100 options</p><b>₹10 - ₹1000</b><p>Veg and Non - veg both</p><h2 class="Restrurent_card_menu">Happy Meal house 10% discount Curry</h6></span><p class="Search_resturent_slider_card_rating fa-solid fa-star"> 4</p></div>
            <div class="Search_resturent_slider_card" onclick="openRestrurentDetails('Happy-Meal-house')"><img src="https://cdn.pixabay.com/photo/2018/11/15/08/19/surface-3816738_640.jpg" alt="Shop image"><span><h6>Happy Meal house</h6><p>Near gargi hostel</p><h5 class="Search_resturent_slider_card_discount">10% discounts</h5><p>100 options</p><b>₹10 - ₹1000</b><p>Veg and Non - veg both</p><h2 class="Restrurent_card_menu">Happy Meal house 20% discount Noodles</h6></span><p class="Search_resturent_slider_card_rating fa-solid fa-star"> 4</p></div>
            <div class="Search_resturent_slider_card" onclick="openRestrurentDetails('Happy-Meal-house')"><img src="https://cdn.pixabay.com/photo/2018/11/15/08/19/surface-3816738_640.jpg" alt="Shop image"><span><h6>Happy Meal house</h6><p>Near gargi hostel</p><h5 class="Search_resturent_slider_card_discount">10% discounts</h5><p>100 options</p><b>₹10 - ₹1000</b><p>Veg and Non - veg both</p><h2 class="Restrurent_card_menu">Happy Meal house 60% discount Cakes</h6></span><p class="Search_resturent_slider_card_rating fa-solid fa-star"> 4</p></div>
            <div class="Search_resturent_slider_card" onclick="openRestrurentDetails('Happy-Meal-house')"><img src="https://cdn.pixabay.com/photo/2018/11/15/08/19/surface-3816738_640.jpg" alt="Shop image"><span><h6>Happy Meal house</h6><p>Near gargi hostel</p><h5 class="Search_resturent_slider_card_discount">20% discounts</h5><p>100 options</p><b>₹10 - ₹1000</b><p>Veg and Non - veg both</p><h2 class="Restrurent_card_menu">Happy Meal house 50% discount Juice</h6></span><p class="Search_resturent_slider_card_rating fa-solid fa-star"> 4</p></div>
        </div>
    </div>
...
window.addEventListener('load', () => {
    ...
    for(let a = 0;a < discountElements.length;a++) {
        ...
        products[a].style.display = textValue.toUpperCase().includes(cardId.toUpperCase()) ? "" : "none";
    }
});
